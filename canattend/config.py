...
caConfig = EasyDict(
    {
        'data': 'metabric', # dataset name, in 'kcpsii', or 'seer'
        ...
        'seed': 1234,
        'checkpoint': './checkpoints/catrace.pt',
        ...
        'out_feature':3, # equals to the length of 'horizons', indicating the output dim of the logit layer 
        'num_event': 1, # when using for competing risks
        'hidden_act': 'gelu',
